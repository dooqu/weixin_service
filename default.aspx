			...
			<ul class="nav main-menu">
				<li>
					<a href="ajax/dashboard.html" class="active ajax-link">
						...
						<span class="hidden-xs">我的账户</span>
					</a>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-bar-chart-o"></i>
						<span class="hidden-xs">我的活动</span>
					</a>
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/charts_xcharts.html">创建活动</a></li>
						<li><a class="ajax-link" href="ajax/charts_flot.html">往期活动</a></li>
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-table"></i>
						 <span class="hidden-xs">我的卡卷</span>
					</a>
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/mycards.aspx">卡卷浏览</a></li>
					</ul>
				</li>
				<li>
					<a href="ajax/dashboard.html" class="active ajax-link">
						<i class="fa fa-dashboard"></i>
						<span class="hidden-xs">我的门店</span>
					</a>
				</li>
                				<li>
					<a href="ajax/dashboard.html" class="active ajax-link">
						<i class="fa fa-dashboard"></i>
						<span class="hidden-xs">数据统计</span>
					</a>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle">
						<i class="fa fa-pencil-square-o"></i>
						 <span class="hidden-xs">版本说明</span>
					</a>
					<ul class="dropdown-menu">
						<li><a class="ajax-link" href="ajax/forms_elements.html">使用帮助</a></li>
						<li><a class="ajax-link" href="ajax/forms_layouts.html">关于</a></li>
					</ul>
				</li>
                <a class="ajax-link" href="ajax/card.aspx">一个测试</a>
				<!--<li class="dropdown">
					<a href="#" class="dropdown-toggle">
